  ...
  const features = [
    {
      ...
      title: 'IA Avançada',
      description: 'Powered by Gemini 2.5 Flash, nossa IA aprende com seu estilo e cria propostas únicas e personalizadas.',
    },
    {
      icon: (
        <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      <div className="container mx-auto px-4 max-w-6xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          {features.map((feature, index) => (
            ...
            >
              <div className="text-vibrant-green mb-4">{feature.icon}</div>
              <h3 className="text-xl font-bold text-dark-blue mb-3">{feature.title}</h3>
